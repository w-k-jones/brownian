...
History:
    ...
    8/11/2016: LM - Made marker size vary according to ball size Balls are 
        overlapping walls and sometimes each other3
    ...
    8/12/2016: WJ - Made new routine to include new wall code.
...
"""
Define # of dimensions for ball position/velocity
"""
nd = 2
